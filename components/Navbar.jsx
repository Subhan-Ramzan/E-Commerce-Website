  ...
  return (
    <div className="relative flex h-20 md:h-16 w-full bg-slate-900 items-center px-6 py-2 text-white justify-between">
      ...
      <form
        ...
        className="flex items-center focus-within:shadow pl-2"
      >
        <input
          type="search"
          placeholder="Search"
          ...
          className=" max-sm:w-[45vw] px-3 py-1 rounded-l-full outline-none text-black"
        />
        <button type="submit" className="bg-blue-700 p-2 rounded-r-full">
          <FaSearch />
        </button>
      </form>
      ...
      {handleFaBar && (
        <div
          className={`flex justify-between fixed w-64 top-3 bottom-3 min-h-[96vh] px-6 py-4 right-2 ${
            handleFaBar ? "translate-x-0" : "translate-x-full"
